...
| Resultado obtido | ✅ APROVADO <br> - Status 400 Bad Request <br> - Mensagem: "O nome do usuário não deve ser vazio" |
| Responsável | Gabriel Henrique |
...
|:---|:---|
| Resultado esperado | Sistema deve retornar status 400 Bad Request e mensagem informando que a data não deve ser futrua |
